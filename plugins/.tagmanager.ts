...
//   const gtmOptions = {
//     id: 'GTM-MMTCTF5', // Your GTM single container ID, array of container ids ['GTM-', 'GTM-'] or array of objects [{id: 'GTM-', queryParams: { gtm_auth: 'abc123', gtm_preview: 'env-4', gtm_cookies_win: 'x'}}, {id: 'GTM-', queryParams: {gtm_auth: 'abc234', gtm_preview: 'env-5', gtm_cookies_win: 'x'}}], // Your GTM single container ID or array of container ids ['GTM-', 'GTM-']
//     queryParams: {
