...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404.0ed17c32.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500.d7371421.mjs'));
...
//# sourceMappingURL=error-component.b4e79a2d.mjs.map
