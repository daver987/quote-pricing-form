...
//reroute to home if there is no quote
...
<template>
  <q-page padding>
    <q-card class="max-w-xl mx-auto q-pa-sm">
      <q-card-section>
        <q-item>
          <q-item-section avatar>
            <q-avatar size="4rem">
              <img src="https://imagedelivery.net/9mQjskQ9vgwm3kCilycqww/041ea32d-630c-4f0c-a2ba-0c0c8f7d5f00/640" alt="Luxury Ride Service" />
            </q-avatar>
          </q-item-section>
          <q-item-section>
      ...
      <q-separator />
      <q-card-section>
        <div class="text-h6">Trip Details For: <span class="font-bold text-h5">{{ fullName }}</span></div>
      </q-card-section>
      <q-card-section horizontal>
        <q-card-section class="col">
          <q-timeline color="primary">
            <q-timeline-entry body heading="Trip Details" />
            <q-timeline-entry title="Pickup" :subtitle="pickupDate" icon="mdi-map-marker-radius" :body="originLocation" />
            <q-timeline-entry title="Drop Off" :subtitle="pickupDate" icon="mdi-map-marker-radius-outline" :body="destinationLocation" />
          </q-timeline>
        </q-card-section>
        <q-card-section class="col">
          <q-img :src="vehicleImage" alt="Vehicle Image" />
          <div class="font-bold text-center text-h5"> {{ vehicleType }} </div>
        </q-card-section>
      </q-card-section>
      <q-separator />
